...
séries temporais, com foco em benchmarks de desempenho.
...
(e.g., consultas pontuais, agregações e outras), avaliando tempo de carga, consumo de espaço e
...
Este trabalho foi projetado com reprodutibilidade como requisito central. Enquanto a maioria
dos estudos revisados se limita a descrever o ambiente de maneira superficial no artigo ou a publicar somente ferramentas
auxiliares, como o gerador de dados de~\citep{shah2022performance}, todos os componentes
necessários para replicação estão publicamente disponíveis, incluindo scripts de orquestração,
imagens Docker com versões fixadas e clientes de benchmark parametrizados. Em relação
a~\citep{pereira2023mulletbench}, único estudo totalmente reprodutível da literatura, este
trabalho acrescenta um Nix flake com arquivo de lock que garante dependências determinísticas
além do Docker.
