...
Da leitura inicial, sete trabalhos foram selecionados para estudo detalhado. Este capítulo está
...
8,65$\times$ na vazão). TimescaleDB e InfluxDB foram destacados como escolhas mais adequadas
