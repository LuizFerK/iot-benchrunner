...
isoladas antes de poderem ser apresentados como propriedades arquiteturais~\citep{shapira2016pitfalls}.
...
\subsubsection{Implantação em Nó Único}

Todos os bancos de dados foram executados em um único host,
...
\subsubsection{Testes de Leitura Sequenciais}

As cargas de trabalho de leitura são executadas
...
\subsubsection{Durabilidade Diferida do IoTDB}

A vazão de escrita do IoTDB reflete o reconhecimento
...
\subsubsection{Aquecimento da JVM}

O desempenho de leitura e de escrita de ponto único do IoTDB
melhora significativamente ao longo da duração de uma sessão à medida que a compilação JIT
otimiza os caminhos quentes~\citep{barrett2017warmup}. Benchmarks curtos subestimam a vazão em estado estacionário.
