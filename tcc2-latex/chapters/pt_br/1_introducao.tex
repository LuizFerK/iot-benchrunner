...
\begin{figure}[ht]
  ...
  \caption{IoT: dispositivos em uso globalmente. Fonte:~\citep{thierer2015iot}.}
...
desempenho por terem sido construídos com o tempo como preocupação central ~~\citep{naqvi2017influxdb}. Além da vazão,
...
Esses recursos são especialmente importantes para aplicações IoT, nas quais medições contínuas de sensores demandam
